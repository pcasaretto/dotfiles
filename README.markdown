...
This has been replaced by [nix + nix-darwin + home-manager](https://github.com/pcasaretto/nix-home)
...
- **topic/\*.xdglink**: Any files ending in `*.xdglink` get symlinked into
  your `$XDG_CONFIG_HOME/topic`. This is so you can keep all of those versioned
